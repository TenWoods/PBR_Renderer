...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Study_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject Study::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Study.data,
    qt_meta_data_Study,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Study::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Study.stringdata0))
